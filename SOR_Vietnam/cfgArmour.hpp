...
class SOR_MOG_Nam: rhsgref_nat_ural
{
	...
	hiddenSelectionsTextures[] = {"SOR_Vietnam\data\SOR_MOG_NAM.paa","rhsafrf\addons\rhs_a2port_car\ural\data\ural_plachta_co.paa"};
...
class SOR_FORDGP_open_Nam: rhsgref_nat_uaz_open
{
	...
	hiddenSelectionsTextures[] = {"SOR_Vietnam\data\SOR_Nam_Jeep.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa","rhsafrf\addons\RHS_Decals\Data\Labels\Misc\no_ca.paa"};
	class TransportItems{};
	class TransportWeapons{};
	class TransportMagazines{};
	class TransportBackpacks{};	
